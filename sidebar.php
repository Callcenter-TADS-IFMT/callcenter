...
<div class="list-group">
  <a href="./chamados_pedentes.php" class="list-group-item ">Chamados pendentes</a>
  <a href="./chamados_atendimento.php" class="list-group-item ">Chamados em atendimento</a>
